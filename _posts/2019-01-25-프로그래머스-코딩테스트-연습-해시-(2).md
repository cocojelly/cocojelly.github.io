...
출처 - [프로그래머스 - 코딩테스트 연습 - 해시 - 전화번호 목록](https://programmers.co.kr/learn/courses/30/lessons/42577?language=python3)
...
1) [내장함수 sorted](https://docs.python.org/3/library/functions.html#sorted) : iterable한 입력값을 정렬한 후 그 결과를 리스트로 리턴하는 함수  

> [iterable](https://docs.python.org/3/glossary.html#term-iterable) : 한 번에 하나의 member를 리턴 가능한 object 또는 `__iter()__`이나 `__getitem__()` 을 써서 정의한 모든 클래스의 object들
>
...
2) [내장함수 zip](https://docs.python.org/3/library/functions.html#zip): 각 iterable의 element들을 모아 iterator를 만드는 함수  

> [iterator](https://docs.python.org/3/glossary.html#term-iterator) : 데이터 스트림을 표현하는 object.  
>
...
3) [str.startswith](https://docs.python.org/3/library/stdtypes.html#str.startswith)(prefix): 문자열 str이 prefix로 시작하면 True를, 그렇지 않으면 False를 리턴하는 string 메소드  
